...
specifying the location of the `.parquet` files. Although there are many
files, this function recognises them as a single dataset, because they
...
= 1` means that only the data revised by the GESLA team and useful for
...
called, it will create this directories and download the full GESLA
...
show with information about that specific station.
