...
#> internet connection.
#> ℹ Connecting to the data server...[K✔ Connecting to the data server... [3.8s][K
#> ℹ Filtering data. This can take some time...[K✔ Filtering data. This can take some time... [2m 38.2s][K
...
#> ℹ Filtering data. This can take some time...[K✔ Filtering data. This can take some time... [2m 9.9s][K
#> ℹ Query finished.[K✔ Query finished. [24ms][K
```
