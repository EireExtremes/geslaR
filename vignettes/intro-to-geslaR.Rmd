...
dataset locally. Note that this may take some time, as it depends on
internet connection. Note that this full dataset will need at least 7GB
of (hard drive) storage, so make sure this is feasible. However, once
downloaded, you will have access to the full dataset, and you will only
...
Since this is a `FileSystemDataset` object, it will actually not load
