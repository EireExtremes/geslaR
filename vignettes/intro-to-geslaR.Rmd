...
#> ℹ Filtering data. This can take some time...[K✔ Filtering data. This can take some time... [3m 1s][K
#> ℹ Query finished.[K✔ Query finished. [14ms][K
da
#> Table
...
#> ℹ This process can take some time, as it depends on the size of the final dataset, and on
#> internet connection.
#> ℹ Connecting to the data server...[K✔ Connecting to the data server... [3.2s][K
#> ℹ Filtering data. This can take some time...[K✔ Filtering data. This can take some time... [2m 44.9s][K
#> ℹ Query finished.[K✔ Query finished. [19ms][K
```
...
#>    year   min    mean   max
#>   <int> <dbl>   <dbl> <dbl>
#> 1  2017 -2.43  0.0762  2.53
#> 2  2015 -2.62 -0.0104  2.38
```
...
As stated before, the queries made by `query _gesla()` may take some
