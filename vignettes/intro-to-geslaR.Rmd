...
#> internet connection.
#> ℹ Connecting to the data server...[K✔ Connecting to the data server... [4.6s][K
#> ℹ Filtering data. This can take some time...[K✔ Filtering data. This can take some time... [6m 21.8s][K
...
#> ℹ This process can take some time, as it depends on the size of the final dataset, and on
#> internet connection.
#> ℹ Connecting to the data server...[K✔ Connecting to the data server... [4.4s][K
#> ℹ Filtering data. This can take some time...[K✔ Filtering data. This can take some time... [4m 21.5s][K
#> ℹ Query finished.[K✔ Query finished. [18ms][K
```
...
function as explained above). Note that the fisrt time this function is
