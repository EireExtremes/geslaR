...
#> [1] 18189361       13
names(da)
#>  [1] "date_time" "year"      "month"     "day"       "hour"      "country"   "site_name"
#>  [8] "lat"       "lon"       "sea_level" "qc_flag"   "use_flag"  "file_name"
```
...
#>  3  2020 -6.37 -0.0558   7.58
#>  4  2021 -3.5  -0.0137   2.86
#>  5  2008 -3.41 -0.00481  4.85
#>  6  2009 -3.00  0.0108   2.94
#>  7  2010 -3.71 -0.0192   3.11
#>  8  2011 -3.17 -0.00690  3.07
#>  9  2012 -3.14 -0.0495   3.28
#> 10  2013 -3.36 -0.0482   3.53
#> # ℹ 53 more rows
```
...
<img src="fig-gg-irl-1.png" alt="plot of chunk gg-irl"  />
<p class="caption">plot of chunk gg-irl</p>
</div>
